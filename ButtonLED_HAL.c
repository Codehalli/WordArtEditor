...
bool ButtonPushed(button_t *button)
{
    ...
    case PRESSED_STATE:
        ...
        // The arc from PUSHED to PUSHED does not need implementation since the state does not change AND its output is also default
    ...
    case RELEASED_STATE:
        ...
        // arc from RELEASED to RELEASED does not need implementation for a similar reason
